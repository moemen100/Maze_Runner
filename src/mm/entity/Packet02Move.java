...
public class Packet02Move extends Packet {
    ...
    public Packet02Move(byte[] data) {
        ...
        this.shooting = Integer.parseInt(dataArray[6]) == 1;
    }

    public Packet02Move(String username, int x, int y, int numSteps, boolean isMoving, int movingDir,boolean shooting) {
        super(02);
    ...
    public byte[] getData() {
        return ("02" + this.username + "," + this.x + "," + this.y + "," + this.numSteps + "," + (isMoving ? 1 : 0)
                + "," + this.movingDir+ "," + (shooting ? 1 : 0)).getBytes();
